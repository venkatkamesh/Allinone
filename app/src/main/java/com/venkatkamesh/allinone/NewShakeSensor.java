...
import android.widget.Toast;
    ...
    public class NewShakeSensor extends Activity implements SensorListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            tv = (TextView) findViewById(R.id.tvshake);
